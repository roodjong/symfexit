...
from symfexit.payments.mollie.payments import MollieProcessor
    ...
    payment = processor.client.payments.create(
        {
            ...
            "webhookUrl": request.build_absolute_uri(reverse("payments_mollie:webhook")),
        }
    )
