...
class TestThemeWriter(TestCase):
    ...
    def test_write_out_overrides(self):
        ...
        with open(settings.BASE_DIR / 'theme' / 'static_src' / 'src' / 'theme-overrides.css') as f:
            content = f.read()
...
class TestAdminThemeWriter(FastTenantTestCase):
    ...
    def test_color_change_from_admin(self):
        ...
        self.assertTrue("Rebuilding theme done" in Task.objects.first().output, Task.objects.first().output)
