...
class BaseLayout[U: GivenContext]:
    def __init__(self, identifier, label, context: U, required: list[str] = None):
        ...
        self.label = label
        self.context = {
            "site_title": _("Main title of this site"),
            "site_url": _("Main site of the organisation"),
            "site_logo": _("Organisation logo"),
            **context,
        }
    ...
    def get_base_context(self) -> U:
        return {
            ...
            "site_url": config.MAIN_SITE,
            "site_logo": f"{config.MAIN_SITE}/{settings.MEDIA_URL}{config.LOGO_IMAGE}",
        }
